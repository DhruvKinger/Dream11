<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="_Default" MaintainScrollPositionOnPostback="true"  %>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
            <h1 class="bg-text-line">Login</h1>
            <p class="mt-4"></p>
          </div>
        </div>
      </div>
    ...
    <div class="site-section bg-light" data-aos="fade-up" align="text-center">
      <div class="container">
        <div class="row align-items-first">
          <div class="col-md-7">
          	<h1 align="align-items-center" class="bg-white" align="text-center" >Login</h1>
            <form id="sad" method="post" class="bg-white" align="text-center" runat="server">
              ...
              <div class="p-3 p-lg-5 border">
                  ...
                  <div class="col-md-12">
                    <label for="c_fname" class="text-black">Username </label>
                      <asp:TextBox runat="server" class="form-control" ID="TextBox1" ></asp:TextBox>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="UserName Required" ControlToValidate="TextBox1"></asp:RequiredFieldValidator>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <asp:TextBox runat="server" class="form-control" ID="TextBox2" textmode="Password"></asp:TextBox>
                ...
                <div><a href="register.aspx">Don't Have An Account!!</a></div>
