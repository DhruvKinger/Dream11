<%@ Page Language="C#" AutoEventWireup="true" CodeFile="changing_password.aspx.cs" Inherits="_Default" MaintainScrollPositionOnPostback="true"%>
        ...
        <div class="container position-relative">
          ...
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li><a href="about.aspx">About Us</a></li>
                 <li> <a href="personal.aspx"><button class="btn btn-primary" type="button" id="b2">Personal</button></a></li>
          </ul>
        </div>
      </nav>
    </header>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
            <h1 class="bg-text-line">Change Password</h1>
            <p class="mt-4">Brain functions are really funny. So, we got your precious word saved.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row align-items-first">
          <div class="col-md-7">
          	...
          	<h1 align="align-items-center" class="bg-white" align="text-center" >Change Password </h1>   
              <form action="" method="post" class="bg-white" align="text-center" runat="server" id="form1">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">New Password <span class="text-danger">*</span></label>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" class="form-control"  TextMode="Password"></asp:TextBox>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Password Again" ControlToValidate="TextBox4"></asp:RequiredFieldValidator>
            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Passwords must match" ControlToCompare="TextBox3" ControlToValidate="TextBox4"></asp:CompareValidator>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                      ...
                      <asp:Button ID="submit" runat="server" Text="Update" OnClick="Button1_Click" class="btn btn-primary btn-lg btn-block"/>
                  </div>
