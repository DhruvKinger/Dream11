<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fixtures.aspx.cs" Inherits="ADMIN_Default"  MaintainScrollPositionOnPostback="true"%>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
            <h1 class="bg-text-line">MATCHES</h1>
            <p class="mt-4">Match details b/w different teams...</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section bg-light" data-aos="fade-up" align="text-center">
      <div class="container">
        <div class="row align-items-first">
          <div class="col-md-7">
          	<h1 align="align-items-center" class="bg-white" align="text-center" >FIXTURES...</h1>
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_fname" class="text-black">Team 1 <span class="text-danger">*</span></label>
                       <asp:DropDownList ID="D1" runat="server" AutoPostBack="True" DataSourceID="ObjectDataSource1" DataTextField="tname" DataValueField="tname" CssClass="form-control">
            </asp:DropDownList>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">Team 2 <span class="text-danger">*</span></label>
                    <asp:DropDownList ID="D2" runat="server" AutoPostBack="True" DataSourceID="SqlDataSource1" DataTextField="tname" DataValueField="tname" CssClass="form-control">
            </asp:DropDownList>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">Venue <span class="text-danger">*</span></label>
                    <asp:DropDownList ID="D3" runat="server" AutoPostBack="True" DataSourceID="ObjectDataSource2" DataTextField="venue" DataValueField="venue" CssClass="form-control">
            </asp:DropDownList>
           </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_email" class="text-black">Date & Time <span class="text-danger">*</span></label>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" AllowPaging="True" Width="550px" PageSize="8">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Date" SortExpression="date">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("date") %>' Width="110px"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
 ...
 <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Disp_Rec" TypeName="dream11.mainteam"></asp:ObjectDataSource>
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="Disp_Rec" TypeName="dream11.mainvdate"></asp:ObjectDataSource>
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=.\sqlexpress;Initial Catalog=dream11;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [team] WHERE ([tname] &lt;&gt; @tname)">
                          <SelectParameters>
                              <asp:ControlParameter ControlID="D1" Name="tname" PropertyName="SelectedValue" Type="String" />
                          </SelectParameters>
                      </asp:SqlDataSource>
                       <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=.\sqlexpress;Initial Catalog=dream11;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="disfixtures" DeleteCommand="delfixtures" DeleteCommandType="StoredProcedure" SelectCommandType="StoredProcedure" UpdateCommand="updfixtures" UpdateCommandType="StoredProcedure">
                           <DeleteParameters>
